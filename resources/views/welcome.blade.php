...
@section('content')
<!-- HERO SECTION -->
<section class="hero" style="min-height: 100vh; display: flex; align-items: center; background: linear-gradient(135deg, rgba(5, 46, 22, 0.85), rgba(6, 78, 59, 0.7), rgba(5, 150, 105, 0.5)), url('{{ asset('hero_farming_mojokerto_1781576055255.png') }}'); background-size: cover; background-position: center; position: relative; overflow: hidden;">
    ...
    <div class="container animate-fade-up" style="position: relative; z-index: 1;">
        <div style="max-width: 850px;">
            <div class="hero-badge" style="display: inline-flex; align-items: center; gap: 0.75rem; padding: 0.6rem 1.5rem; background: rgba(16, 185, 129, 0.2); backdrop-filter: blur(12px); border-radius: 99px; color: #6ee7b7; font-weight: 800; font-size: 0.85rem; margin-bottom: 2.5rem; border: 1px solid rgba(16, 185, 129, 0.3);">
                <i class="fas fa-certificate"></i> Digitalizing Agriculture in Mojokerto
            </div>
...
<section style="margin-top: -5rem; position: relative; z-index: 10;">
    <div class="container">
        <div class="stats-grid glass-card" style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 2rem; text-align: center; padding: 3rem;">
